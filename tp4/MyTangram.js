...
export class MyTangram extends CGFobject {
  constructor(scene) {
      ...
      this.triangleSmall1 = new MyTriangleSmall(this.scene, false);
      this.triangleSmall2 = new MyTriangleSmall(this.scene, true);
      this.triangleBig1 = new MyTriangleBig(this.scene, false);
      this.triangleBig2 = new MyTriangleBig(this.scene, true);
